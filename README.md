...
| GET                   | `/reports/sales-by-customer`, `/reports/sales-by-product`, `/reports/shortages` (sales) · `/reports/collections-by-customer` · `/reports/stock` (catalog) | Tabular reports for a date range (`from`/`to`, default month to date): rows + totals                                                                                                                          |
