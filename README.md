...
| GET        | `/admin/overview`                                 | Totals (incl. `pendingAccessRequests`), tenants by plan, 12-month sign-ups, 6-month collections, top tenants by outstanding balance                                                                                                 |
...
81 unit tests in 12 files (`tests/`) cover the pure logic; they don't need a database:
