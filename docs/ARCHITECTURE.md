...
- **Roadmap**: purchases from suppliers (positive `purchase` movements) and stock adjustments under the `inventory` module, then reports (best sellers, margin, stock value); electronic receipts through a SUNAT provider later.
