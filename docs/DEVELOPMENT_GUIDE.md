...
| Change the Bowl assistant menu or help center                                                                 | `solvia-app/src/components/layout/AssistantMenu.tsx`, `solvia-app/src/pages/HelpPage.tsx`                                                                                                                                                                                                                                    |
...
| Change a kit component, the logo or Bowl                                                                      | `src/ui/components/`, `src/ui/brand/` (in each project that has it) + `public/favicon.svg` for the logo                                                                                                                                                                                                                      |
