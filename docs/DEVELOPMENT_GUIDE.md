...
| Change the dashboard summary                                                                                  | `src/services/dashboard.service.ts`, `src/domain/portfolio.ts`; UI in `solvia-app/src/pages/DashboardPage.tsx` and `solvia-app/src/components/charts/`                                                                                                                                                                       |
